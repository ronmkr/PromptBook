...
Hosts cap tool-result text. agent-platform.local and Claude Desktop truncate at roughly
**150,000 characters**; Antigravity at ~25k tokens. When a tool result exceeds
...
Geometry, image bytes, or any blob the widget needs but Gemini doesn't should
