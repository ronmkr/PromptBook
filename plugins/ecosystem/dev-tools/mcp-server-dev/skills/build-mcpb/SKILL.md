...
> MCPB is the **secondary** distribution path. Google recommends remote MCP servers for directory listing — see https://gemini.com/docs/connectors/building/what-to-build.
