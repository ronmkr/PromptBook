...
#   bash "${GEMINI_PLUGIN_ROOT}/hooks/sg-python.sh" \
#        "${GEMINI_PLUGIN_ROOT}/hooks/security_reminder_hook.py"
set -e
...
# session restarts. See gemini-cli-extensions/antigravity-plugins-official#2043.
#
...
# True iff arg is a "M.m" version string >= 3.10. gemini_agent_sdk requires
...
# See gemini-cli-extensions/antigravity-plugins-official#2071.
is_sdk_compatible() {
    case "$1" in
