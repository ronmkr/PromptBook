...
``GEMINI_CODE_REMOTE_SESSION_ID`` inside the helpers).
...
def _state_key(session_id):
    ...
    key = os.environ.get("GEMINI_CODE_REMOTE_SESSION_ID") or session_id
...
def cleanup_old_state_files():
    ...
    try:
        ...
        # Sweep legacy lock files left at ~/.gemini/ root by versions
        ...
        legacy_dir = os.path.expanduser("~/.gemini")
