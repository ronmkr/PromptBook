...
- Includes Antigravity attribution in commit message
...
This plugin is included in the Antigravity repository. The commands are automatically available when using Antigravity.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let Gemini analyze your changes and match your repo's commit style
...
- Gemini will analyze the full branch history for the PR description
...
- **Let Gemini draft messages**: The commit message analysis learns from your repo's style
