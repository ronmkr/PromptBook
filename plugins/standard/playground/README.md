...
The user adjusts controls, explores visually, then copies the generated prompt back into Gemini.
...
Add this plugin to your Antigravity configuration to enable the playground skill.
