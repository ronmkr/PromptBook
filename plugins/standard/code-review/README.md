...
2. Gathers relevant GEMINI.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for GEMINI.md compliance
...
- GEMINI.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (GEMINI.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/GEMINI.md says "Use camelCase for functions")
...
- General quality issues (unless in GEMINI.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the Antigravity repository. The command is automatically available when using Antigravity.

## Best Practices

### Using `/code-review`
- Maintain clear GEMINI.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update GEMINI.md based on recurring review patterns
...
- GEMINI.md files (optional but recommended for guideline checking)
...
- Make GEMINI.md more specific about what matters
...
- **Write specific GEMINI.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update GEMINI.md based on patterns
...
### Agent architecture
- **2x GEMINI.md compliance agents**: Redundancy for guideline checks
...
- For GEMINI.md issues: verifies guideline explicitly mentions it
...
Boris Cherny (boris@platform.local)
