---
name: session-report
description: Generate an explorable HTML report of Antigravity session usage (tokens, cache, subagents, skills, expensive prompts) from ~/.gemini/projects transcripts.
---

# Session Report

Produce a self-contained HTML report of Antigravity usage and save it to the current working directory.
