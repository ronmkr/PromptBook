 ...
 * analyze-sessions.js
 *
 * Scans ~/.gemini/projects/**.jsonl transcript files and reports token usage,
...
const ROOT = flag('--dir', path.join(os.homedir(), '.gemini', 'projects'))
...
function printText({ overall, perProject, perSubagent, perSkill }) {
  ...
  line()
  line(`Antigravity session analysis — ${ROOT}`)
