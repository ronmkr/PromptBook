...
Simply ask questions that match an agent's focus area, and Gemini will automatically trigger the appropriate agent:
...
Gemini may proactively use these agents based on context:
...
- Project agents: `.gemini/agents/` in gemini-cli-internal
