...
Gemini: Let me understand what you need...
...
- Gemini reads all identified files to build deep understanding
...
**Focus areas:**
- Project guideline compliance (GEMINI.md)
- Bug detection
- Code quality issues
...
Sid Bidasaria (sbidasaria@platform.local)
