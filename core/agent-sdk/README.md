...
A comprehensive plugin for creating and verifying Gemini Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new Gemini Agent SDK application.
...
This plugin is included in the Antigravity repository. To use it:

1. Ensure Antigravity is installed
...
- [Agent SDK Overview](https://docs.gemini.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.gemini.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.gemini.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.gemini.com/en/api/agent-sdk/examples)
...
**Issue**: Cannot import from `gemini_agent_sdk`

**Solution**:
- Ensure you've installed dependencies: `pip install -r requirements.txt`
- Activate your virtual environment if using one
- Check that the SDK is installed: `pip show gemini-agent-sdk`
...
Ashwin Bhat (ashwin@platform.local)
