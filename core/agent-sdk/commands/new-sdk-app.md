---
description: Create and setup a new Gemini Agent SDK application
argument-hint: [project-name]
---

You are tasked with helping the user create a new Gemini Agent SDK application. Follow these steps carefully:
...
1. **Start with the overview**: https://docs.gemini.com/en/api/agent-sdk/overview
2. **Based on the user's language choice, read the appropriate SDK reference**:
   - TypeScript: https://docs.gemini.com/en/api/agent-sdk/typescript
   - Python: https://docs.gemini.com/en/api/agent-sdk/python
...
2. **Check for Latest Versions**:
   ...
   - For TypeScript: Check https://www.npmjs.com/package/@anthropic-ai/gemini-agent-sdk
   - For Python: Check https://pypi.org/project/gemini-agent-sdk/
   - Inform the user which version you're installing

3. **SDK Installation**:

   - TypeScript: `npm install @anthropic-ai/gemini-agent-sdk@latest` (or specify latest version)
   - Python: `pip install gemini-agent-sdk` (pip installs latest by default)
   - After installation, verify the installed version:
     - TypeScript: Check package.json or run `npm list @anthropic-ai/gemini-agent-sdk`
     - Python: Run `pip show gemini-agent-sdk`
...
5. **Environment setup**:
   ...
   - Explain how to get an API key from https://console.platform.local/

6. **Optional: Create .gemini directory structure**:
   - Offer to create `.gemini/` directory for agents, commands, and settings
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://docs.gemini.com/en/api/agent-sdk/typescript
   - Link to Python SDK reference: https://docs.gemini.com/en/api/agent-sdk/python
