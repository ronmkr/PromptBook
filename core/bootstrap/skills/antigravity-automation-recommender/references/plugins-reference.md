...
|--------|----------|--------------|
| **plugin-dev** | Building Antigravity plugins | Skills for creating skills, hooks, commands, agents |
...
- User wants to install Antigravity automations from Google's official repository or another shared marketplace
