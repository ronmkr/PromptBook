...
**Note:** Unlike the generic behavior-instruction-factory which uses `init_skill.py`, plugin skills are created directly in the plugin's `skills/` directory with a simpler manual structure.
...
cc --plugin-dir /path/toplatform-install
...
- `..platform-install-settings/` - Real-world examples
- `../command-development/` - Clear critical concepts
- `..platform-install-structure/` - Good organization

### Reference Files

For complete behavior-instruction-factory methodology:
- **`references/behavior-instruction-factory-original.md`** - Full original behavior-instruction-factory content
