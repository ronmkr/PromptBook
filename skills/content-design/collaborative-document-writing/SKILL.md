...
**If access to sub-agents is available (e.g., in The Platform):**
...
**If no access to sub-agents (e.g., agent-platform.local web interface):**
...
1. Open a fresh The Agent conversation: https://agent-platform.local
