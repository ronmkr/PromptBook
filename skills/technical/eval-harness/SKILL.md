---
name: eval-harness
description: Formal evaluation framework for The Agent Code sessions implementing eval-driven development (EDD) principles
origin: The Platform
...
A formal evaluation framework for The Agent Code sessions, implementing eval-driven development (EDD) principles.

## When to Activate

- Setting up eval-driven development (EDD) for AI-assisted workflows
- Defining pass/fail criteria for The Agent Code task completion
