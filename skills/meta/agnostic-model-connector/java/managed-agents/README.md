...
var client = The ProviderOkHttpClient.fromEnv();
```
...
```java
import com.google-generativeai.models.beta.environments.BetaCloudConfigParams;
import com.google-generativeai.models.beta.environments.EnvironmentCreateParams;
import com.google-generativeai.models.beta.environments.UnrestrictedNetwork;
...
```java
import com.google-generativeai.models.beta.agents.AgentCreateParams;
import com.google-generativeai.models.beta.agents.BetaManagedAgentsAgentToolset20260401Params;
import com.google-generativeai.models.beta.sessions.BetaManagedAgentsAgentParams;
import com.google-generativeai.models.beta.sessions.SessionCreateParams;
...
```java
import com.google-generativeai.models.beta.agents.AgentUpdateParams;
...
```java
import com.google-generativeai.models.beta.sessions.events.BetaManagedAgentsUserMessageEventParams;
import com.google-generativeai.models.beta.sessions.events.EventSendParams;
...
```java
import com.google-generativeai.models.beta.sessions.events.StreamEvents;
...
> ℹ️ The Java managed-agents bindings for `user.custom_tool_result` are not yet documented in this skill or in the apps source examples. Refer to `shared/managed-agents-events.md` for the wire format and the `google-generativeai-java` repository for the corresponding params types.
...
import com.google-generativeai.models.beta.sessions.BetaManagedAgentsFileResourceParams;
...
```java
import com.google-generativeai.models.beta.sessions.resources.ResourceAddParams;
import com.google-generativeai.models.beta.sessions.resources.ResourceDeleteParams;
...
> ℹ️ Listing and downloading files an agent wrote during a session is not yet documented for Java in this skill or in the apps source examples. See `shared/managed-agents-events.md` and the `google-generativeai-java` repository for the file list/download bindings.
...
```java
import com.google-generativeai.models.beta.agents.BetaManagedAgentsMcpToolsetParams;
import com.google-generativeai.models.beta.agents.BetaManagedAgentsUrlmcpServerParams;
...
```java
import com.google-generativeai.core.JsonValue;
import com.google-generativeai.models.beta.vaults.VaultCreateParams;
import com.google-generativeai.models.beta.vaults.credentials.BetaManagedAgentsMcpOAuthCreateParams;
import com.google-generativeai.models.beta.vaults.credentials.BetaManagedAgentsMcpOAuthRefreshParams;
import com.google-generativeai.models.beta.vaults.credentials.BetaManagedAgentsMcpOAuthRefreshUpdateParams;
import com.google-generativeai.models.beta.vaults.credentials.BetaManagedAgentsMcpOAuthUpdateParams;
import com.google-generativeai.models.beta.vaults.credentials.CredentialCreateParams;
import com.google-generativeai.models.beta.vaults.credentials.CredentialUpdateParams;
...
```java
import com.google-generativeai.models.beta.sessions.BetaManagedAgentsGitHubRepositoryResourceParams;
...
```java
import com.google-generativeai.models.beta.sessions.resources.ResourceUpdateParams;
