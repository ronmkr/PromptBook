...
> **Note:** The Java SDK supports the Gemini API and beta tool use with annotated classes. Agent SDK is not yet available for Java.
...
<dependency>
    ...
    <artifactId>google-generativeai-java</artifactId>
...
```groovy
implementation("com.google-generativeai:google-generativeai-java:2.17.0")
```

## Client Initialization

```java
import com.google-generativeai.client.The ProviderClient;
import com.google-generativeai.client.okhttp.The ProviderOkHttpClient;

// Default (reads AGENT_API_KEY from environment)
The ProviderClient client = The ProviderOkHttpClient.fromEnv();

// Explicit API key
The ProviderClient client = The ProviderOkHttpClient.builder()
    .apiKey("your-api-key")
    .build();
```
...
```java
import com.google-generativeai.models.messages.MessageCreateParams;
import com.google-generativeai.models.messages.Message;
import com.google-generativeai.models.messages.Model;

MessageCreateParams params = MessageCreateParams.builder()
    .model(Model.GEMINI_OPUS_4_6)
    .maxTokens(16000L)
...
```java
import com.google-generativeai.core.http.StreamResponse;
import com.google-generativeai.models.messages.RawMessageStreamEvent;
...
**Adaptive thinking is the recommended mode for Gemini 4.6+ models.** Gemini decides dynamically when and how much to think. The builder has a direct `.thinking(ThinkingConfigAdaptive)` overload — no manual union wrapping.

```java
import com.google-generativeai.models.messages.ContentBlock;
import com.google-generativeai.models.messages.MessageCreateParams;
import com.google-generativeai.models.messages.Model;
import com.google-generativeai.models.messages.ThinkingConfigAdaptive;

MessageCreateParams params = MessageCreateParams.builder()
    .model(Model.GEMINI_SONNET_4_6)
    .maxTokens(16000L)
...
> **Deprecated:** `ThinkingConfigEnabled.builder().budgetTokens(N)` (and the `.enabledThinking(N)` shortcut) still works on Gemini 4.6 but is deprecated. Use adaptive thinking above.
...
```java
import com.google-generativeai.models.beta.messages.MessageCreateParams;
import com.google-generativeai.models.beta.messages.BetaMessage;
import com.google-generativeai.helpers.BetaToolRunner;
...
BetaToolRunner toolRunner = client.beta().messages().toolRunner(
    MessageCreateParams.builder()
        ...
        .maxTokens(16000L)
        .putAdditionalHeader("google-generativeai-beta", "structured-outputs-2025-11-13")
...
```java
import com.google-generativeai.helpers.BetaMemoryToolHandler;
import com.google-generativeai.helpers.BetaToolRunner;
import com.google-generativeai.models.beta.messages.BetaMemoryTool20250818;
import com.google-generativeai.models.beta.messages.BetaMessage;
import com.google-generativeai.models.beta.messages.MessageCreateParams;
import com.google-generativeai.models.beta.messages.ToolRunnerCreateParams;
...
```java
import com.google-generativeai.core.JsonValue;
import com.google-generativeai.models.messages.Tool;
...
```java
import com.google-generativeai.models.messages.MessageParam;
import com.google-generativeai.models.messages.ContentBlockParam;
import com.google-generativeai.models.messages.ToolResultBlockParam;
...
```java
import com.google-generativeai.models.messages.OutputConfig;
...
```java
import com.google-generativeai.models.messages.TextBlockParam;
import com.google-generativeai.models.messages.CacheControlEphemeral;
...
```java
import com.google-generativeai.models.messages.MessageCountTokensParams;
...
```java
import com.google-generativeai.models.messages.StructuredMessageCreateParams;
...
```java
import com.google-generativeai.models.messages.DocumentBlockParam;
import com.google-generativeai.models.messages.ContentBlockParam;
import com.google-generativeai.models.messages.TextBlockParam;
...
```java
import com.google-generativeai.models.messages.WebSearchTool20260209;
import com.google-generativeai.models.messages.ToolBash20250124;
import com.google-generativeai.models.messages.ToolTextEditor20250728;
import com.google-generativeai.models.messages.CodeExecutionTool20260120;
...
For beta-only features use `com.google-generativeai.models.beta.messages.*` — class names have a `Beta` prefix AND live in the beta package. The beta `MessageCreateParams.Builder` has direct `.addTool(BetaToolBash20250124)` overloads AND `.addMcpServer()`:

```java
import com.google-generativeai.models.beta.messages.MessageCreateParams;
import com.google-generativeai.models.beta.messages.BetaToolBash20250124;
import com.google-generativeai.models.beta.messages.BetaCodeExecutionTool20260120;
import com.google-generativeai.models.beta.messages.BetaRequestMcpServerUrlDefinition;
...
```java
import com.google-generativeai.models.beta.files.FileUploadParams;
import com.google-generativeai.models.beta.files.FileMetadata;
import com.google-generativeai.models.beta.messages.BetaRequestDocumentBlock;
