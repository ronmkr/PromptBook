...
> **Note:** The Ruby SDK supports the Gemini API. A tool runner is available in beta via `client.beta.messages.tool_runner()`. Agent SDK is not yet available for Ruby.
...
```ruby
class GetWeatherInput < The Provider::BaseModel
  required :location, String, doc: "City and state, e.g. San Francisco, CA"
end

class GetWeather < The Provider::BaseTool
